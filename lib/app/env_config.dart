...
abstract class EnvConfig {
  ...
  ///
  /// CHỈ dùng để trình diễn khi chưa có BE chạy. Bị chặn ở build `prod` để
  /// một lần truyền nhầm cờ không thể biến bản phát hành thành bản giả lập.
  static const bool _demoModeFlag =
