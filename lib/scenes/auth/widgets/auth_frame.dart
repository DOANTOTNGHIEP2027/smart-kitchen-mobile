              ...
              child: AutofillGroup(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(subtitle, style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: AppColors.muted), textAlign: TextAlign.center),
...
class FeatureBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Semantics(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isError ? const Color(0xFFFFEEEE) : AppColors.primarySoft,
            borderRadius: BorderRadius.circular(AppDimens.radiusSm),
          ),
          child: Row(children: [
            Icon(isError ? Icons.error_outline : Icons.info_outline, color: isError ? AppColors.danger : AppColors.primary),
...
String errorCopy(String code) => errorCopyKey(code).tr;
