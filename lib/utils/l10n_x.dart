...
extension FeatureL10nKeyX on String {
  String localized(BuildContext context) {
    ...
    return switch (this) {
      ...
      'auth_forgot_password_link' => l10n.authForgotPasswordLink,
      'auth_forgot_password_title' => l10n.authForgotPasswordTitle,
      'auth_forgot_password_hint' => l10n.authForgotPasswordHint,
      'auth_send_reset_otp' => l10n.authSendResetOtp,
      'auth_reset_password_title' => l10n.authResetPasswordTitle,
      'auth_reset_password_submit' => l10n.authResetPasswordSubmit,
      'auth_new_password' => l10n.authNewPassword,
      'auth_confirm_password' => l10n.authConfirmPassword,
      'auth_password_mismatch' => l10n.authPasswordMismatch,
      'auth_reset_success' => l10n.authResetSuccess,
      'auth_otp_cooldown' => l10n.authOtpCooldown,
      'auth_too_many_attempts' => l10n.authTooManyAttempts,
      'auth_email_invalid' => l10n.authEmailInvalid,
      'auth_password_short' => l10n.passwordHint,
